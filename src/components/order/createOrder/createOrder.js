        ...
        {this.state.user.type === 'admin'?<AdminNavbar />:null}
          ...
          <div className='card-form order-form'>
            ...
            <div className='card-body col-md-offset-3' style={{height:'auto'}}>
              ...
              <div className='card-field'>
                <div className='col-md-9'>
                    <label className='large mb-1'>Produit</label>
                    <input
                      name='product'
                  ...
                  <div className='col-md-9'>
                    <label className='large mb-1'>Prix</label>
                    <input
                      name='price'
                      className='form-control py-2'
                      value={product.price}
                  ...
                  <div className='col-md-9'>
                    <label className='large mb-1'>Quantité</label>
                    <input
                      name='quantity'
                      className='form-control py-2'
                      placeholder='Entrez la quantité à commander'
                      onChange={this.handleChange}
                    ></input>
                  </div>
                  <div className='col-md-9'>
                    <label className='large mb-1'
                    >Options de paiement</label>
                  ...
                  <div className='col-md-9'>
                  <label className='large mb-1'>Secteur</label>
            ...
            {sectors? sectors.map(dt=>(<option key={dt.id} value={dt.id}>{dt.sector}</option>)):null}
                  ...
                  <div className='col-md-9'>
                    <label className='large mb-1'>Voisinage</label>
                    <input
                      name='quantity'
                      className='form-control py-2'
                      placeholder='Entrez dans votre quartier'
