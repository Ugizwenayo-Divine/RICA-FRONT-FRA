...
const { userLogout } = userHelper;

const { searchAny, searchAll } = search;
class LandingHeader extends Component {
  ...
  componentWillReceiveProps = (nextProps) => {
    ...
    alertMessage =
      nextProps.searchErrors && toast.error("Le produit n' est pas disponible");
        ...
        <div className='grid-container'>
          ...
          <div className='grid-item search'>
            <form className='search-form' onSubmit={this.handleEnterPress}>
              <span className='all'>
                <span onClick={this.handleSubmitAll}>TOUS</span>
              ...
              ></input>
              <span className='icon' onClick={this.handleSubmit}>
          ...
          <div
            ...
            style={{ visibility: !localToken ? 'visible' : 'hidden' }}
          >
          ...
          {!localToken ? (
            ...
            <div className='grid-item'>
              <Link to='/displayclientorders'> Commandes &nbsp;&nbsp;</Link>
          ...
          <div className='grid-item navbar'>
            ...
            <Link to='#'>Vidéos</Link>
            <span style={{ fontWeight: '500' }} onClick={this.handleClick}>
              Consultante
            </span>
            <Link to='/displaynews'>Nouvelles</Link>
            {this.state.loggedInUser ? (
              this.state.loggedInUser.type === 'admin' ? (
