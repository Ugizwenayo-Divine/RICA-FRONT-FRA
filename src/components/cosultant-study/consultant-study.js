    ...
    return (
      ...
      <div className='container'>
        <div>
          ...
          <div style={{width:'100%', marginLeft:'0', textAlign:'center', fontFamily:'Montserrat', fontWeight:'bold', fontSize:'30px'}}>BIENVENUE à RICA</div>
              ...
              data.map(data=>(<div style={{width:'100%',height:'auto'}} key={data.id}>
                <img 
                  ...
                  <div style={{width:'100%', marginBottom:'3%', marginTop:'2%', marginLeft:'2%',marginRight:'auto'}}>
                    <h4>La description <i className='fas fa-info-circle'></i></h4>
