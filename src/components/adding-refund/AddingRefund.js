...
class AddingRefund extends Component {
  ...
  componentWillReceiveProps = (nextProps) => {
    const alertMessage =
      ...
      (nextProps.refundErrors && toast.error('La demande de remboursement n\'est pas autorisée pour cette commande'));
              ...
              <form className='form-group' onSubmit={this.handleSubmit}>
                <div className='form-row'>
                  <div className='col-md-12'>
                    <label className='small mb-1'>Numéro de commande</label>
                    <input
                      type='number'
                      name='refundOrder'
                  ...
                  <div className='col-md-12'>
                    <label className='small mb-1'>La description</label>
                    <textarea
                      rows='4'
                      cols='20'
                      name='description'
