      ...
      return (
        <div 
          ...
          <span className="nav-item">
            <a className="nav-link" href="/clientrefund">REMBOURSEMENTS</a>
          </span>
          <span className="nav-item">
            <a className="nav-link" href="/displayclientorders">COMMANDES</a>
          </span>
          <span 
            className='nav-item ml-auto log'
            onClick={this.handleLogout}>SE DÉCONNECTER</span>
        </div>
      )
  }
}
