    ...
    return (
      <div style={{width:'100%'}}>
        ...
        {this.state.user.type === 'admin'?<AdminNavbar />:null}
          ...
          }>{this.state.user.firstName} {this.state.user.lastName} Remboursements</h4>
...
export default connect(mapStateToProps, {getClientRefunds:clientRefunds})(ClientRefund);